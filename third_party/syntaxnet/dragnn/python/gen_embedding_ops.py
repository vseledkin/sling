...
# _word_embedding_initializer_outputs = ["word_embeddings"]
def fast_text_embedding_initializer(vectors, name=None):
    r"""Reads word embeddings from an sstable of dist_belief.TokenEmbedding protos for
    ...
    """
    result = _op_def_lib.apply_op("FastTextEmbeddingInitializer", vectors=vectors,
                                  name=name)
    return result


_ops.RegisterShape("FastTextEmbeddingInitializer")(None)
...
op {
  name: "FastTextEmbeddingInitializer"
  attr {
    name: "vectors"
    type: "string"
  }
